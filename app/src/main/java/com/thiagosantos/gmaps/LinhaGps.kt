...
class LinhaGps : AppCompatActivity() {
        ...
        lifecycleScope.launch {
            ...
            if (response.isSuccessful) {
                ...
                if (body != null) {
                    ...
                    Log.d(ContentValues.TAG, "Lista de Linhas desta LINHA+========+++++>>>>>>>>-> Teste saída: ${body}")
                }
            }
        }
    }
    ...
    private fun getLinhasIntent(){
        ...
        letreiro.text = linha?.letreiro + " " + (linha?.destino) + " | " + (linha?.origem) + " --> " + (linha?.destino)
        ...
        mapFragment.getMapAsync { googleMap ->
            ...
            googleMap.setOnMapLoadedCallback {
                ...
                listLinhas.observe(this){
                    ...
                    bounds.include(LatLng(it.parada.relacaoLinhas[0].relacaoVeiculos[0].latitudeVeiculo, it.parada.relacaoLinhas[0].relacaoVeiculos[0].longitudeVeiculo))
        ...
        listLinhas.observe(this){ ponto ->
            ...
            val markerParada = mMap.addMarker(
                MarkerOptions()
                    ...
                    .icon(BitmapHelper.vectorToBitmap(this, R.drawable.ic_bus_stop_icon, ContextCompat.getColor(this, R.color.teal_200)))
            )
                ...
                linhas.relacaoVeiculos.forEach{ v ->
                    ...
                    val marker = mMap.addMarker(
                        MarkerOptions()
                            ...
                            .icon(BitmapHelper.vectorToBitmap(this, R.drawable.ic_baseline_directions_bus_24, ContextCompat.getColor(this, R.color.teal_200)))
                    )
